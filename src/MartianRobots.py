...
# Can be on of Test, Normal or Verbose
mode = 'Normal'
...
if mode == 'Verbose':
    ...
    listRobots = collections.OrderedDict()
    ...
    r1.move('R', mars)
    r1.move('F', mars)
    print("{} {} {} {}".format(r1.xPos, r1.yPos, r1.orientation, 'LOST' if r1.isLost else ''))
    del r1
    ...
    r2.move('L', mars)
    r2.move('L', mars)
    print("{} {} {} {}".format(r2.xPos, r2.yPos, r2.orientation, 'LOST' if r2.isLost else ''))
    del r2
    ...
    r3.move('F', mars)
    r3.move('L', mars)
    print("{} {} {} {}".format(r3.xPos, r3.yPos, r3.orientation, 'LOST' if r3.isLost else ''))
    del r3
